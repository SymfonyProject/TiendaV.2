...
class ClientesController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('clientes_show', array('idclientes' => $cliente->getIdclientes()));
        }
     ...
     *
     * @Route("/{idclientes}", name="clientes_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{idclientes}/edit", name="clientes_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Clientes $cliente)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('clientes_edit', array('idclientes' => $cliente->getIdclientes()));
        }
     ...
     *
     * @Route("/{idclientes}", name="clientes_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Clientes $cliente)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('clientes_delete', array('idclientes' => $cliente->getIdclientes())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
